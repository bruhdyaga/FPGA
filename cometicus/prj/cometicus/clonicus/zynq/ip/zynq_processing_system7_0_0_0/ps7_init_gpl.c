...
unsigned long ps7_clock_init_data_3_0[] = {
    ...
    // .. ..     ==> MASK : 0x01000000U    VAL : 0x01000000U
    // .. .. 
    EMIT_MASKWRITE(0XF800012C, 0x01FFCCCDU ,0x017C048DU),
    // .. .. SEL = 0x0
...
unsigned long ps7_ddr_init_data_3_0[] = {
    ...
    // .. .. reg_ddrc_t_rc = 0xb
    // .. .. ==> 0XF8006014[5:0] = 0x0000000BU
    // .. ..     ==> MASK : 0x0000003FU    VAL : 0x0000000BU
    // .. .. reg_ddrc_t_rfc_min = 0x27
    // .. .. ==> 0XF8006014[13:6] = 0x00000027U
    // .. ..     ==> MASK : 0x00003FC0U    VAL : 0x000009C0U
    // .. .. reg_ddrc_post_selfref_gap_x32 = 0x10
    // .. .. ==> 0XF8006014[20:14] = 0x00000010U
    // .. ..     ==> MASK : 0x001FC000U    VAL : 0x00040000U
    // .. .. 
    EMIT_MASKWRITE(0XF8006014, 0x001FFFFFU ,0x000409CBU),
    // .. .. reg_ddrc_wr2pre = 0xb
    // .. .. ==> 0XF8006018[4:0] = 0x0000000BU
    ...
    // .. .. 
    EMIT_MASKWRITE(0XF8006018, 0xF7FFFFFFU ,0x420D24CBU),
    ...
    // .. ..     ==> MASK : 0x00007C00U    VAL : 0x00002800U
    // .. .. reg_ddrc_t_xp = 0x2
    // .. .. ==> 0XF800601C[19:15] = 0x00000002U
    // .. ..     ==> MASK : 0x000F8000U    VAL : 0x00010000U
    // .. .. reg_ddrc_pad_pd = 0x0
    ...
    // .. .. reg_ddrc_t_rcd = 0x5
    // .. .. ==> 0XF800601C[31:28] = 0x00000005U
    // .. ..     ==> MASK : 0xF0000000U    VAL : 0x50000000U
    // .. .. 
    EMIT_MASKWRITE(0XF800601C, 0xFFFFFFFFU ,0x520128E3U),
    // .. .. reg_ddrc_t_ccd = 0x2
    // .. .. ==> 0XF8006020[4:2] = 0x00000002U
    // .. ..     ==> MASK : 0x0000001CU    VAL : 0x00000008U
    // .. .. reg_ddrc_t_rrd = 0x2
    // .. .. ==> 0XF8006020[7:5] = 0x00000002U
    // .. ..     ==> MASK : 0x000000E0U    VAL : 0x00000040U
    // .. .. reg_ddrc_refresh_margin = 0x2
    // .. .. ==> 0XF8006020[11:8] = 0x00000002U
    // .. ..     ==> MASK : 0x00000F00U    VAL : 0x00000200U
    // .. .. reg_ddrc_t_rp = 0x5
    // .. .. ==> 0XF8006020[15:12] = 0x00000005U
    ...
    // .. .. 
    EMIT_MASKWRITE(0XF8006020, 0x7FDFFFFCU ,0x25085248U),
    ...
    // .. .. reg_ddrc_t_mrd = 0x2
    // .. .. ==> 0XF8006028[13:11] = 0x00000002U
    // .. ..     ==> MASK : 0x00003800U    VAL : 0x00001000U
    // .. .. 
    EMIT_MASKWRITE(0XF8006028, 0x00003FFFU ,0x00001007U),
    // .. .. reg_ddrc_emr2 = 0x0
    ...
    // .. .. reg_ddrc_mr = 0x553
    // .. .. ==> 0XF8006030[15:0] = 0x00000553U
    // .. ..     ==> MASK : 0x0000FFFFU    VAL : 0x00000553U
    // .. .. reg_ddrc_emr = 0x44
    // .. .. ==> 0XF8006030[31:16] = 0x00000044U
    // .. ..     ==> MASK : 0xFFFF0000U    VAL : 0x00440000U
    // .. .. 
    EMIT_MASKWRITE(0XF8006030, 0xFFFFFFFFU ,0x00440553U),
    // .. .. reg_ddrc_burst_rdwr = 0x4
    // .. .. ==> 0XF8006034[3:0] = 0x00000004U
    // .. ..     ==> MASK : 0x0000000FU    VAL : 0x00000004U
    // .. .. reg_ddrc_pre_cke_x1024 = 0x28
    // .. .. ==> 0XF8006034[13:4] = 0x00000028U
    // .. ..     ==> MASK : 0x00003FF0U    VAL : 0x00000280U
    ...
    // .. .. 
    EMIT_MASKWRITE(0XF8006034, 0x13FF3FFFU ,0x00010284U),
    ...
    // .. .. 
    EMIT_MASKWRITE(0XF800605C, 0x0000FFFFU ,0x00004013U),
    ...
    // .. .. reg_phy_gatelvl_init_ratio = 0x7d
    // .. .. ==> 0XF800612C[19:10] = 0x0000007DU
    // .. ..     ==> MASK : 0x000FFC00U    VAL : 0x0001F400U
    // .. .. 
    EMIT_MASKWRITE(0XF800612C, 0x000FFFFFU ,0x0001F400U),
    // .. .. reg_phy_wrlvl_init_ratio = 0x0
    // .. .. ==> 0XF8006130[9:0] = 0x00000000U
    // .. ..     ==> MASK : 0x000003FFU    VAL : 0x00000000U
    // .. .. reg_phy_gatelvl_init_ratio = 0x7d
    // .. .. ==> 0XF8006130[19:10] = 0x0000007DU
    // .. ..     ==> MASK : 0x000FFC00U    VAL : 0x0001F400U
    // .. .. 
    EMIT_MASKWRITE(0XF8006130, 0x000FFFFFU ,0x0001F400U),
    // .. .. reg_phy_wrlvl_init_ratio = 0x0
    // .. .. ==> 0XF8006134[9:0] = 0x00000000U
    // .. ..     ==> MASK : 0x000003FFU    VAL : 0x00000000U
    // .. .. reg_phy_gatelvl_init_ratio = 0x7d
    // .. .. ==> 0XF8006134[19:10] = 0x0000007DU
    // .. ..     ==> MASK : 0x000FFC00U    VAL : 0x0001F400U
    // .. .. 
    EMIT_MASKWRITE(0XF8006134, 0x000FFFFFU ,0x0001F400U),
    // .. .. reg_phy_wrlvl_init_ratio = 0x0
    // .. .. ==> 0XF8006138[9:0] = 0x00000000U
    // .. ..     ==> MASK : 0x000003FFU    VAL : 0x00000000U
    // .. .. reg_phy_gatelvl_init_ratio = 0x7e
    // .. .. ==> 0XF8006138[19:10] = 0x0000007EU
    // .. ..     ==> MASK : 0x000FFC00U    VAL : 0x0001F800U
    // .. .. 
    EMIT_MASKWRITE(0XF8006138, 0x000FFFFFU ,0x0001F800U),
    ...
    // .. .. reg_phy_fifo_we_slave_ratio = 0x52
    // .. .. ==> 0XF8006168[10:0] = 0x00000052U
    // .. ..     ==> MASK : 0x000007FFU    VAL : 0x00000052U
    ...
    // .. .. 
    EMIT_MASKWRITE(0XF8006168, 0x001FFFFFU ,0x00000052U),
    // .. .. reg_phy_fifo_we_slave_ratio = 0x52
    // .. .. ==> 0XF800616C[10:0] = 0x00000052U
    // .. ..     ==> MASK : 0x000007FFU    VAL : 0x00000052U
    // .. .. reg_phy_fifo_we_in_force = 0x0
    ...
    // .. ..     ==> MASK : 0x001FF000U    VAL : 0x00000000U
    // .. .. 
    EMIT_MASKWRITE(0XF800616C, 0x001FFFFFU ,0x00000052U),
    // .. .. reg_phy_fifo_we_slave_ratio = 0x52
    // .. .. ==> 0XF8006170[10:0] = 0x00000052U
    // .. ..     ==> MASK : 0x000007FFU    VAL : 0x00000052U
    // .. .. reg_phy_fifo_we_in_force = 0x0
    ...
    // .. ..     ==> MASK : 0x001FF000U    VAL : 0x00000000U
    // .. .. 
    EMIT_MASKWRITE(0XF8006170, 0x001FFFFFU ,0x00000052U),
    // .. .. reg_phy_fifo_we_slave_ratio = 0x53
    // .. .. ==> 0XF8006174[10:0] = 0x00000053U
    // .. ..     ==> MASK : 0x000007FFU    VAL : 0x00000053U
    // .. .. reg_phy_fifo_we_in_force = 0x0
    ...
    // .. ..     ==> MASK : 0x001FF000U    VAL : 0x00000000U
    // .. .. 
    EMIT_MASKWRITE(0XF8006174, 0x001FFFFFU ,0x00000053U),
    ...
    // .. .. 
    EMIT_MASKWRITE(0XF8006194, 0x000FFFFFU ,0x00003C41U),
...
unsigned long ps7_mio_init_data_3_0[] = {
    ...
    // .. reserved_DRIVE_P = 0x30
    // .. ==> 0XF8000B5C[6:0] = 0x00000030U
    // ..     ==> MASK : 0x0000007FU    VAL : 0x00000030U
    // .. reserved_DRIVE_N = 0x30
    // .. ==> 0XF8000B5C[13:7] = 0x00000030U
    // ..     ==> MASK : 0x00003F80U    VAL : 0x00001800U
    // .. reserved_SLEW_P = 0x1
    // .. ==> 0XF8000B5C[18:14] = 0x00000001U
    // ..     ==> MASK : 0x0007C000U    VAL : 0x00004000U
    // .. reserved_SLEW_N = 0x3
    ...
    // .. 
    EMIT_MASKWRITE(0XF8000B5C, 0xFFFFFFFFU ,0x00185830U),
    // .. reserved_DRIVE_P = 0x38
    // .. ==> 0XF8000B60[6:0] = 0x00000038U
    // ..     ==> MASK : 0x0000007FU    VAL : 0x00000038U
    // .. reserved_DRIVE_N = 0x3c
    // .. ==> 0XF8000B60[13:7] = 0x0000003CU
    // ..     ==> MASK : 0x00003F80U    VAL : 0x00001E00U
    // .. reserved_SLEW_P = 0x1
    // .. ==> 0XF8000B60[18:14] = 0x00000001U
    // ..     ==> MASK : 0x0007C000U    VAL : 0x00004000U
    ...
    // ..     ==> MASK : 0xF8000000U    VAL : 0x00000000U
    // .. 
    EMIT_MASKWRITE(0XF8000B60, 0xFFFFFFFFU ,0x00F85E38U),
    // .. reserved_DRIVE_P = 0x38
    // .. ==> 0XF8000B64[6:0] = 0x00000038U
    // ..     ==> MASK : 0x0000007FU    VAL : 0x00000038U
    // .. reserved_DRIVE_N = 0x3c
    // .. ==> 0XF8000B64[13:7] = 0x0000003CU
    // ..     ==> MASK : 0x00003F80U    VAL : 0x00001E00U
    // .. reserved_SLEW_P = 0x1
    // .. ==> 0XF8000B64[18:14] = 0x00000001U
    // ..     ==> MASK : 0x0007C000U    VAL : 0x00004000U
    // .. reserved_SLEW_N = 0x1f
    ...
    // ..     ==> MASK : 0xF8000000U    VAL : 0x00000000U
    // .. 
    EMIT_MASKWRITE(0XF8000B64, 0xFFFFFFFFU ,0x00F85E38U),
    // .. reserved_DRIVE_P = 0x30
    // .. ==> 0XF8000B68[6:0] = 0x00000030U
    // ..     ==> MASK : 0x0000007FU    VAL : 0x00000030U
    // .. reserved_DRIVE_N = 0x30
    // .. ==> 0XF8000B68[13:7] = 0x00000030U
    // ..     ==> MASK : 0x00003F80U    VAL : 0x00001800U
    // .. reserved_SLEW_P = 0x3
    ...
    // ..     ==> MASK : 0xF8000000U    VAL : 0x00000000U
    // .. 
    EMIT_MASKWRITE(0XF8000B68, 0xFFFFFFFFU ,0x00F8D830U),
    // .. VREF_INT_EN = 0x0
    ...
    // ..     ==> MASK : 0x00002000U    VAL : 0x00000000U
    // .. 
    EMIT_MASKWRITE(0XF8000738, 0x00003F01U ,0x00001601U),
    // .. TRI_ENABLE = 0
    ...
    // ..     ==> MASK : 0x00002000U    VAL : 0x00000000U
    // .. 
    EMIT_MASKWRITE(0XF80007D0, 0x00003FFFU ,0x000012A0U),
    // .. TRI_ENABLE = 0
    ...
    // ..     ==> MASK : 0x00002000U    VAL : 0x00000000U
    // .. 
    EMIT_MASKWRITE(0XF80007D4, 0x00003FFFU ,0x000012A0U),
    // .. SDIO0_WP_SEL = 55
...
unsigned long ps7_ddr_init_data_2_0[] = {
    ...
    // .. .. 
    EMIT_MASKWRITE(0XF8006020, 0xFFFFFFFCU ,0x25285248U),
    // .. .. reg_ddrc_en_2t_timing_mode = 0x0
    // .. .. ==> 0XF8006024[0:0] = 0x00000000U
    // .. ..     ==> MASK : 0x00000001U    VAL : 0x00000000U
    // .. .. reg_ddrc_prefer_write = 0x0
