...
file copy -force c/data_collector_tb.c           tmp_compile/

# debug
vlog -quiet -reportprogress 300 -work debug data_collector_tb.sv +incdir+../verilog_sv +incdir+$SUB_PATH/interfaces
vlog -quiet -reportprogress 300 -work debug ../verilog_sv/data_collector.sv +incdir+../verilog +incdir+$SUB_PATH/interfaces
...
tmp_compile/data_collector_tb.c \
tmp_compile/axi_rw.c

# run
quit -sim
vsim -novopt debug.data_collector_tb
do wave/data_collector_tb.do
run 5 us
