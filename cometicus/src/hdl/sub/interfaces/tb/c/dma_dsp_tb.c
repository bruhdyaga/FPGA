...
int cpu_sim() {
    ...
    axi_write(pBASE, DMA_OFFS + 2  , 0x00000008); // source addr
    axi_write(pBASE, DMA_OFFS + 3  , 0x00000008); // destination addr
    axi_write(pBASE, DMA_OFFS + 1  , 0x80000000 | 3); // RUN and length
