...
file copy -force c/axi3_interconnect_tb.c        tmp_compile/
...
vlog -quiet -reportprogress 300 -work $WORK_LIB axi3_interconnect_tb.sv \
+incdir+../verilog \
+incdir+$SUB_PATH/interfaces \
+incdir+$PATH_globalparam \
+incdir+$PATH_boardparam
...
tmp_compile/axi3_interconnect_tb.c \
tmp_compile/axi_rw.c

# run
quit -sim
vsim -novopt $WORK_LIB.axi3_interconnect_tb
do wave/axi3_interconnect_tb.do
run 15 us
