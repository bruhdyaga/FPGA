...
file copy -force c/axi_uartlite_spi_tb.c        tmp_compile/
...
vlog -quiet -reportprogress 300 -work $WORK_LIB axi_uartlite_spi_tb.sv \
+incdir+../verilog \
+incdir+$SUB_PATH/interfaces \
+incdir+$PATH_globalparam \
+incdir+$PATH_boardparam
...
tmp_compile/axi_uartlite_spi_tb.c \
tmp_compile/axi_rw.c

# run
quit -sim
vsim -novopt $WORK_LIB.axi_uartlite_spi_tb
do wave/axi_uartlite_spi_tb.do
run 15 us
