...
file copy -force c/dma_dsp_tb.c                  tmp_compile/

vlog -quiet -reportprogress 300 -work $WORK_LIB dma_dsp_tb.sv +incdir+../verilog +incdir+$SUB_PATH/interfaces +incdir+$PATH_globalparam +incdir+$PATH_boardparam

vlog -quiet -reportprogress 300 -work $WORK_LIB $PATH_interface/cpu_sim.sv \
tmp_compile/dma_dsp_tb.c \
tmp_compile/axi_rw.c

# run
quit -sim
vsim -novopt $WORK_LIB.dma_dsp_tb
do wave/dma_dsp_tb.do
run 15 us
